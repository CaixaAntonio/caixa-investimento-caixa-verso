...
namespace Painel.Investimento.Testes.UseCaseTests
{
    public class ConsultarHistoricoSimulacoesUseCaseTests
    {
        ...
        private readonly Mock<ILogger<ConsultarHistoricoSimulacoesUseCase>> _loggerMock;
        ...
        public ConsultarHistoricoSimulacoesUseCaseTests()
        {
            ...
            _loggerMock = new Mock<ILogger<ConsultarHistoricoSimulacoesUseCase>>();

            _useCase = new ConsultarHistoricoSimulacoesUseCase(
